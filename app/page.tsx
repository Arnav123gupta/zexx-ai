    ...
    <div className="flex flex-col h-screen bg-black text-green-400 font-mono">
      ...
      <div className="relative z-10 w-full px-4 py-4">
        <div className="mb-8 border-b border-green-500/30 pb-4">
          <div className="terminal-text mb-2">
            ...
            <span className="text-green-400 ml-2 animate-pulse">SYSTEM INITIALIZED</span>
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-green-400 glow-green mb-2">N3TW0RK GPT v2.0</h1>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="text-xs text-cyan-400 font-mono">
              ...
              <div className="mt-1 hidden sm:block">{">>>"} Methodology: Recon → Scanning → Enumeration → Exploitation → Post-Exploitation</div>
            </div>
        ...
        <div className="flex h-[calc(100vh-200px)] gap-4">
          {/* ChatGPT-like sidebar - Hidden on mobile by default */}
          {showSidebar && (
            <div className="hidden md:flex w-64 border-r border-green-500/30 bg-black/60 backdrop-blur-sm flex-col">
              <button
